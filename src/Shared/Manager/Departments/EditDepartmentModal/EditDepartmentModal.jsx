  ...
  useEffect(() => {
    if (selectedDepartment) {
      reset({
        ...
        budget_notes: selectedDepartment.budget?.notes || "",
        budget_annual: selectedDepartment.budget?.annual || 0,
        department_Code: selectedDepartment.department_Code || "",
        department_Name: selectedDepartment.department_Name || "",
        budget_quarterly: selectedDepartment.budget?.quarterly || 0,
        budget_allocated: selectedDepartment.budget?.allocated || 0,
        roles: selectedDepartment.roles || [{ role: "", description: "" }],
      });
    }
  ...
  const onSubmit = async (data) => {
    try {
      ...
      const payload = {
        ...
        roles: data.roles,
        budget: {
          annual: Number(data.budget_annual),
          quarterly: Number(data.budget_quarterly),
          allocated: Number(data.budget_allocated),
