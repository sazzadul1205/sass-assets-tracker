  ...
  useEffect(() => {
    ...
    reset({
      ...
      purchase_date: selectedAsset.purchase_date
        ...
        : "",
      purchase_price: Number(selectedAsset.purchase_price) || "",
      supplier_name: selectedAsset.supplier_name ?? "",
      warranty_period: Number(selectedAsset.warranty_period) || "",
      warranty_expiry_date: selectedAsset.warranty_expiry_date
        ? new Date(selectedAsset.warranty_expiry_date).toISOString().split("T")[0]
        : "",
      depreciation_rate: Number(selectedAsset.depreciation_rate) || "",
    });
  }, [selectedAsset, reset]);
